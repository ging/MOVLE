  ...
  class Application < Rails::Application
    ...
    config.after_initialize do
      ...
      if database_exists
        ...
        #Demo user
        config.demo_user = User.find_by_email("demo@movle.es") if (ActiveRecord::Base.connection.table_exists? "users" and !User.find_by_email("demo@movle.es").nil?)
      end
    end
