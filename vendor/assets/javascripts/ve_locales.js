VE_Locales = {
	"en": {
		...
		"i.Publishing"				: "Publishing",
		"i.Publish_confirmation"	: "You are going to save and publish this Presentation on the MOVLE Platform. After this, the presentation will be public and anyone will be able to access it. What would you like to do?",
		"i.Quiz"					: "Quiz",
		...
		"i.Unpublishing"			: "Unpublishing",
		"i.Unpublish_confirmation"	: "You are going to unpublish this Presentation from the MOVLE Platform. After this, the presentation will be private and only you will be able to access it. What would you like to do?",
		"i.Unknown"					: "Unknown",
		...
		"i.uploadHasToSaveFirst"	: "You must save Presentation first, before uploading any file",
		"i.url"						: "url",
		"i.Url"						: "Url",
		"i.Version"					: "Version",
		"i.Vertical"				: "Vertical",
	...
	"es": {
		...
		"i.walkWelcome7_1"			: "Este botón te permite publicar tu presentación en la plataforma MOVLE. Si no has terminado tu presentación, puedes guardarla como borrador para mantenerla privada y terminarla después.",
		...
		"i.walkSettings1_2"			: "Aquí puedes especificar información acerca de tu Presentación Interactiva.",
		"i.walkSettings1_3"			: "El título y el avatar (una imagen que identifica tu presentación en la plataforma MOVLE) son campos obligatorios, de modo que debes rellenarlos antes de publicar la presentación.",
		"i.walkSettings1_4"			: "A la izquierda, puedes ver una previsualización de como tu presentación será mostrada en la plataforma MOVLE.",
		"i.walkSettings2_1"			: "Escribe un título (Obligatorio)",
		"i.walkSettings2_2"			: "Escribe el título de tu presentación en esta caja de texto. Este titulo es importante porque es el que se mostrará en la plataforma MOVLE y el que verán el resto de usuarios.",
		"i.walkSettings3_1"			: "Añade un avatar para tu presentación (Obligatorio)",
		"i.walkSettings3_2"			: "Pulsa sobre este botón para elegir una imagen que represente a tu presentación. Esta imagen será el avatar de tu presentación y es importante porque será mostrada en la plataforma MOVLE, permitiendo a los usuarios identificar la presentación.",
		...
		"i.walkSettings5_3"			: "Esta descripción será mostrada en la plataforma MOVLE en la página de esta presentación. Por lo tanto, todos los usuarios que accedan a esta presentación podrán leerla.",
		...
		"i.walkSettings7_3"			: "Estas palabras clave son muy útiles para categorizar la presentación. Además, también se emplean como términos de búsqueda en la plataforma MOVLE (asi como en otros repositorios), y por lo tanto añadir palabras clave a una presentación facilita su búsqueda y acceso.",
		...
		"i.walkSettings8_3"			: "Para subir un fichero adjunto debes haber guardado previamente la presentación. Una vez subido el fichero adjunto, los usuarios podrán descargarlo desde la página de la presentación en la plataforma MOVLE.",
		...
		"i.walkPublication1_2"		: "En esta pantalla podrás cambiar los permisos que tendrán el resto de usuarios de la plataforma MOVLE sobre tu presentación una vez publicada. Podrás cambiar esta configuración en cualquier momento.",
		...
		"i.walkLive_2"				: "ViSH ofrece recursos especiales como webcams en vivo, microscopios o laboratorios virtuales provistos por determinadas ciberinfraestructuras.",
		...
		"i.walkInsertingViSHPres_1"	: "Añadiendo Diapositivas de Presentaciones Interactivas",
		"i.walkInsertingViSHPres_2"	: "Aquí puedes buscar Presentaciones Interactivas en la plataforma ViSH para añadirlas (o añadir determinadas diapositivas de ellas) a tu presentación.",
		"i.walkInsertingViSHPres_3"	: "Haz click en cualquiera de las Presentaciones Interactivas para seleccionarla. Después, se mostrará un nuevo botón 'Vista Previa'. Cuando pulses este botón, aparecerá una nueva ventana para que elijas las diapositivas que quieres insertar en tu presentación.",
		"i.walkPresSearch2"			: "y pulsa la tecla 'intro' para comenzar la búsqueda. Cuando termine la búsqueda, las Presentaciones Interactivas encontradas serán mostradas en esta pantalla.",
		...
		"i.Publishing"				: "Publicando",
		"i.Publish_confirmation"	: "Vas a guardar y publicar esta presentación en MOVLE. Después de esto, la presentación será pública y cualquiera podrá acceder a ella. ¿Qué deseas hacer?",
		"i.Quiz"					: "Quiz",
		...
		"i.Unpublishing"			: "Retirando",
		"i.Unpublish_confirmation"	: "Vas a retirar la publicación de esta presentación de la plataforma MOVLE. Después de esto la presentación será privada y solo tú podras acceder a ella. ¿Qué deseas hacer?",
