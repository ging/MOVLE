class PresentationsController < ApplicationController
  ...
  def presentation_thumbnails
    ...
    81.times do |index|
      ...
      thumbnail["src"] = Movle::Application.config.full_domain + "/assets/logos/original/excursion-"+tnumber+".png"
    ...
    respond_to do |format|  
      format.json {
        ...
        if responseFormat == "json"
          ...
          t.write json
          t.close
          results["url"] = "#{Movle::Application.config.full_domain}/presentations/tmpJson.json?fileId=#{tmpFileName}"
          ...
          results["url"] = "#{Movle::Application.config.full_domain}/tmp/scorm/#{fileName}.zip"
           ...
           results["url"] = "#{Movle::Application.config.full_domain}/tmp/qti/#{fileName}.zip"
           ...
           results["url"] = "#{Movle::Application.config.full_domain}/tmp/moodlequizxml/#{fileName}.xml"
